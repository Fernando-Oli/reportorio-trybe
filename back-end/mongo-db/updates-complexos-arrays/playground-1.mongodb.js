...
//🚀 Exercício 10: Crie um array de documentos chamado cast para o filme Batman 
// com os seguintes dados:
...
//do filme Batman os valores "Michael Keaton", "Val Kilmer" 
//e "George Clooney", e deixe o array em ordem alfabética.

db.movies.updateOne(
    { title: 'Batman', 'cast.character': 'Batman' },
    { $push: { 'cast.$.actor': { $each: ['Michael Keaton', 'Val Kilmer', 'Georget Clooney'], $sort: 1 }}}
)
